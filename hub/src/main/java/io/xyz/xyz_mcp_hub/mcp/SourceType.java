 ...
 * <li>{@link #COMPOSITE} — 组合源：由 {@code mcp.specs} YAML 发布的派生源</li>
 * </ul>
 *
 * <p>目录 JSON 中序列化为小写 {@link #value()}（native/proxy/container/host/composite），与
 * ADR-0011 目录 schema 一致。作为 {@link McpEndpointProvider#getSourceType()} 的返回类型，是
 * #35/#36/#37（proxy / container / 组合源迁入注册表）共用的元数据模型，一次定稿。</p>
 */
public enum SourceType {
	...
	/** 目录 JSON 中的小写取值（native/proxy/container/host/composite）。 */
	public String value() {
